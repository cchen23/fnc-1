...
TRAIN_BODY_CSV = '../data/train_bodies.csv' # NOTE: added ../ to path
TRAIN_STANCE_CSV = '../data/train_stances.csv' # NOTE: added ../ to path

TEST_BODY_CSV = '../data/test_bodies.csv' # NOTE: added ../ to path
TEST_HEADLINE_CSV = '../data/test_stances_unlabeled.csv' # NOTE: added ../ to path
...
for (body_id, body) in test_id2body.items(): # NOTE: Changed for python3.
